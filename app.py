...
def kesimpulan():
    ...
    #st.success(f"Organisasi telah memenuhi **{st.session_state['domain1']}** dari {st.session_state['pertanyaan1']} persyaratan Konteks Organisasi.")
    #st.success(f"Organisasi telah memenuhi **{st.session_state['domain2']}** dari {st.session_state['pertanyaan2']} persyaratan Kepemimpinan.")
    #st.success(f"Organisasi telah memenuhi **{st.session_state['domain3']}** dari {st.session_state['pertanyaan3']} persyaratan Perencanaan.")
    #st.success(f"Organisasi telah memenuhi **{st.session_state['domain4']}** dari {st.session_state['pertanyaan4']} persyaratan Dukungan.")
    #st.success(f"Organisasi telah memenuhi **{st.session_state['domain5']}** dari {st.session_state['pertanyaan5']} persyaratan Evaluasi.")
    #st.success(f"Organisasi telah memenuhi **{st.session_state['domain6']}** dari {st.session_state['pertanyaan6']} persyaratan Kendali Organisasi.")
    #st.success(f"Organisasi telah memenuhi **{st.session_state['domain7']}** dari {st.session_state['pertanyaan7']} persyaratan Kendali Manusia.")
    #st.success(f"Organisasi telah memenuhi **{st.session_state['domain8']}** dari {st.session_state['pertanyaan8']} persyaratan Kendali Fisik.")
    #st.success(f"Organisasi telah memenuhi **{st.session_state['domain9']}** dari {st.session_state['pertanyaan9']} persyaratan Kendali Teknologi.")
    ...
    st.success(f"Organisasi telah memenuhi **{total_domain}** atau {total_domain / total_pertanyaan * 100}% dari {total_pertanyaan} persyaratan SMKI.")
    ...
    if tampilkan_tabel:
        st.info("Klik kotak di atas untuk menyembunyikan tabel")
        st.table(df)
    else:
        st.info("Klik kotak di atas untuk menampilkan tabel")
